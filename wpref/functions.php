...
function depo_square_status_widget() { 
			...
			<h3>Status</h3>
			<p><a href="<?php bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=depo-square">Setup your post type categories</a> to have your latest status message appear here.</p>
			<?php endif;?>
			<?php endif;?>
<?php }
